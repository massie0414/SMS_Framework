project.sms: project.ihx
	makesms project.ihx project.sms

project.ihx: main.rel \
banked_code_1.rel \
banked_code_2.rel \
banked_code_3.rel \
banked_code_4.rel \
